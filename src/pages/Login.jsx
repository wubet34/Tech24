...
const Login = () => {
  ...
  return (
    <div className="force-dark min-h-screen flex items-center justify-center px-6 relative overflow-hidden">
      {/* BG glows */}
      <div className="absolute top-0 left-0 w-96 h-96 bg-orange-500/8 rounded-full blur-3xl -translate-x-1/2 -translate-y-1/2" />
      <div className="absolute bottom-0 right-0 w-96 h-96 bg-orange-600/6 rounded-full blur-3xl translate-x-1/2 translate-y-1/2" />
      ...
      >
        ...
        <div className="rounded-3xl p-9 relative overflow-hidden"
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-white/40 text-sm">Sign in to your Tech24 account</p>

            {/* Demo credentials — remove before going live */}
            <div className="mt-4 rounded-xl border border-orange-500/20 bg-orange-500/8 px-4 py-3 text-left">
              <p className="text-orange-400 text-xs font-semibold mb-1.5">Demo Admin Credentials</p>
              <p className="text-white/50 text-xs">Email: <span className="text-white font-mono">admin@tech24.com</span></p>
              <p className="text-white/50 text-xs">Password: <span className="text-white font-mono">admin123456</span></p>
            </div>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="flex items-center justify-between text-xs">
              ...
              <button type="button" className="text-orange-400 hover:text-orange-300 transition">Forgot Password?</button>
            </div>
          ...
          <p className="mt-7 text-center text-white/30 text-xs">
            ...
            <Link to="/register" className="text-orange-400 hover:text-orange-300 font-medium transition">Register</Link>
          </p>
        </div>
      </motion.div>
    </div>

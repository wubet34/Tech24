...
const Contact = () => (
  <div style={{ color: "var(--text)" }}>
    ...
    <section className="relative max-w-7xl mx-auto px-6 pt-36 pb-16 text-center overflow-hidden">
      ...
      <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }} className="relative">
        <span className="inline-block rounded-full border border-orange-500/30 bg-orange-500/10 px-4 py-1 text-xs font-semibold uppercase tracking-[0.2em] text-orange-500 mb-6">Contact Us</span>
        <h1 className="text-5xl md:text-6xl font-black leading-tight mb-6 gradient-text">Get In Touch With Our Team</h1>
    ...
    <section className="max-w-7xl mx-auto px-6 pb-32">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
        ...
        <div className="space-y-5">
          {[
            { icon: MapPin, title: "Visit Us",      lines: ["Gofe Gebriel, Addis Ababa, Ethiopia"] },
            { icon: Phone,  title: "Call Us",       lines: ["+251 911 234 567"], note: "Emergency: 24/7" },
            { icon: Mail,   title: "Email Us",      lines: ["info@tech24.com", "support@tech24.com"] },
            { icon: Clock,  title: "Working Hours", lines: ["Mon – Fri: 8:00 – 18:00", "Sat: 9:00 – 13:00"] },
          ...
          >
            ...
            <p className="text-2xl font-black text-white">+251 911 000 000</p>
          </motion.div>
        </div>

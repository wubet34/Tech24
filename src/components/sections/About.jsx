...
const About = () => (
  <div style={{ color: "var(--text)" }}>
    ...
    {/* Team */}
    <section className="max-w-7xl mx-auto px-6 py-24">
      <SectionHeading eyebrow="Leadership" title="The Team Behind Tech24" subtitle="Meet the experts driving Ethiopia's ATM service revolution." className="mb-14" />
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        {TEAM.map(({ name, role, bio, icon }, i) => {
          const Icon = TEAM_ICONS[icon] || UserCircle2;
          return (
            <AnimatedCard key={i} delay={i * 0.1} hover3d className="p-8 text-center group">
